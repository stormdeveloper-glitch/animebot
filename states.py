...
class AdminStates(StatesGroup):
    ...
    add_anime_age = State()    # Yangi: Yosh toifasi
    add_anime_description = State() # Yangi: Tavsif qo'shish (AI ishlamasa)
